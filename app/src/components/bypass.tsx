...
export default function BypassButton({
  ...
  return <button className='icon toolbar-button' title={isBypassed ? 'Resume Color-Blind Simulation' : 'View as normal vision' } onClick={evt => toggleBypassed(evt as unknown as Event)}>
    { isBypassed === true ? (
